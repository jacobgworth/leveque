...
<body>
  <div class="w-nav navbar" data-collapse="medium" data-animation="default" data-duration="400" data-contain="1">
    ...
    <a href="http://newstorycharity.org/#impact" class="w-nav-link nav-link _2" style="max-width: 940px;">Impact</a><a href="http://newstorycharity.org/families-page" class="w-nav-link nav-link _2" style="max-width: 940px;">Help Fund a Family</a><div data-delay="0" class="w-dropdown dropdown" style="max-width: 940px;"></div><a href="http://newstorycharity.org/donate" class="w-nav-link nav-link _2" style="max-width: 940px;">Donate</a>
