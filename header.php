...
<head>
  ...
  <meta name="description" content="Mission of Hope and New Story are partnering together to see these families, their lifestyle, and their homes restored to completion.  100% of your funds go towards the supplies and construction for this project.">
...
<!-- share this widget script starts here -->  
<script type="text/javascript">var switchTo5x=true;</script>
<script type="text/javascript" src="https://ws.sharethis.com/button/buttons.js"></script>
<script type="text/javascript">stLight.options({publisher: "b70c9d11-12e7-413e-944a-acd66343b9bb", doNotHash: false, doNotCopy: false, hashAddressBar: false});</script>
<!-- share this widget script ends here -->
<meta property="og:image"
content="https://leveque.newstorycharity.org/images/moh.jpg" />

</head>
<body>
  <div class="w-nav navbar" data-collapse="medium" data-animation="default" data-duration="400" data-contain="1">
    <div class="w-container"><a class="w-nav-brand" href="index.php"><img width="100" src="images/logo (2).png" class="logo moh"></a>
      <nav class="w-nav-menu" role="navigation">
<?php
 if(isset($_SESSION['get_started'])) {
?>
<a target="_blank" href="campaign-tips.php" class="w-nav-link nav-link _2" style="max-width: 940px;">Get Started</a>
<?php unset($_SESSION['get_started']); } ?>


<?php
 if($_SESSION['logged_user_id']==1) {
?>
<a href="admin-campaigns.php" class="w-nav-link nav-link _2" style="max-width: 940px;">List Campaigns</a>
<a href="admin-donors.php" class="w-nav-link nav-link _2" style="max-width: 940px;">List Donors</a>
<?php } ?>
        ...
        while($rows=mysql_fetch_array($qury))
          ...
          <a class="w-dropdown-link navbar-dropdown-link" href="campaign-tips.php">Campaign Tips</a>
		  <a class="w-dropdown-link navbar-dropdown-link" href="logout.php">Log Out</a>
          </nav>
        </div>
      </nav>
