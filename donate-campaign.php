...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO `campaign_donation` (amount,firstname,lastname,email,message) VALUES ('" . $amount . "','" . $name . "','" . $email . "','" . $message . "')";
...
<div class="donate-section">
    <div id="supportFormWrapper">
        <div id="supportingForm">
            <h1>You're donating to <?php echo $campaign['campaignsname']; ?></h1>
