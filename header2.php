...
<body>
  <div class="w-nav navbar" data-collapse="medium" data-animation="default" data-duration="400" data-contain="1">
    ...
    <a href="campaign-tips.php" class="w-nav-link nav-link _2" style="max-width: 940px;">Get Started</a>
	<?php if(!isset($_SESSION['logged_user_id'])) { ?>
  <a href="login.php" class="w-nav-link nav-link _2" style="max-width: 940px;">Login</a>
  <a href="create-campaign.php" class="w-nav-link nav-link _2" style="max-width: 940px;">Register</a>
